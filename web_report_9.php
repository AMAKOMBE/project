    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 mt-5">
                ...
                <span><a href="web_report_9.php" class="btn btn-outline-secondary active">SEPTEMBER</a></span>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                where r_id = reg_id and company_name = '$project' and month like 'september' group by d_name,travel_distance,tap_go,accidents,month";
